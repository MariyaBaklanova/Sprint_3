...
class TestLogin:
    ...
    def test_login_through_authorization_button(self, driver, login_data):  # по кнопке «Войти в аккаунт» на главной
    ...
    def test_login_through_profile_button(self, driver, login_data):  # через кнопку «Личный кабинет»
        driver.implicitly_wait(3)
    ...
    def test_login_through_login_link(self, driver, login_data):  # через кнопку в форме регистрации
        driver.implicitly_wait(3)
        driver.find_element(By.XPATH, Locators.PROFILE_BUTTON).click()
    ...
    def test_login_through_forgot_password_link(self, driver, login_data):  # через кнопку в форме восстановления пароля
        driver.implicitly_wait(3)
        driver.find_element(By.XPATH, Locators.AUTHORIZATION_BUTTON).click()
